...
class StreamingApi {
  ...
  /// Add a stream to the authenticated user&#39;s favorites.
  /// Adds the stream to the user&#39;s favorites (US-04-05). Idempotent (PUT): adding an already-favorited stream succeeds. A stream that is not visible to the requester (private and owned by someone else, archived, or unknown) returns 404.
  ///
  /// Parameters:
  /// * [id]
  ...
  Future<Response<void>> addFavorite({
    ...
    final _path = r'/api/streams/{id}/favorite'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Delete (archive) a stream (owner only).
  ///
  ///
  /// Parameters:
  /// * [id]
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteStream({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/streams/{id}'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Get a stream by id.
  /// The owner receives the full stream (including stream_key and stream_source_url). Other users receive a public summary without secrets. A private stream owned by someone else returns 404.
  ///
  /// Parameters:
  /// * [id]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// List the authenticated user&#39;s favorite streams.
  /// Returns the user&#39;s favorite streams (all statuses), still visible and not archived, ordered by favorite date descending. Never exposes any secret (stream_key, source URL).
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<StreamSummaryResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<StreamSummaryResponse>>> listMyFavorites({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/users/me/favorites';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    List<StreamSummaryResponse>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<StreamSummaryResponse>, StreamSummaryResponse>(
              rawData,
              'List<StreamSummaryResponse>',
              growable: true,
            );
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<List<StreamSummaryResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// List the authenticated user&#39;s own streams (broadcaster dashboard).
  /// Returns the caller&#39;s own streams (all statuses: idle, live, ended), archived ones excluded, ordered by creation date descending. Unlike every other listing endpoint, this one DOES include stream_key and stream_source_url: the query is scoped to the caller&#39;s user id, so the recipient is the owner by construction. A user with no streams — for instance one who does not hold the broadcaster role — receives an empty array rather than a 403.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<StreamResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<StreamResponse>>> listMyStreams({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/users/me/streams';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    List<StreamResponse>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<StreamResponse>, StreamResponse>(
              rawData,
              'List<StreamResponse>',
              growable: true,
            );
    ...
    return Response<List<StreamResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Remove a stream from the authenticated user&#39;s favorites.
  /// Removes the stream from the user&#39;s favorites. Idempotent: removing a stream that is not in the favorites succeeds.
  ///
  /// Parameters:
  /// * [id]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future] containing a [Response] with a [StreamResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StreamResponse>> updateStream({
    required String id,
    required CreateStreamRequest createStreamRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
