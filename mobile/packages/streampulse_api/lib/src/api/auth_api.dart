...
class AuthApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageResponse>> forgotPassword({
    ...
    final _path = r'/api/auth/forgot-password';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenPairResponse>> login({
  ...
  Future<Response<void>> logout({
    ...
    try {
      _bodyData = jsonEncode(logoutRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Returns a [Future] containing a [Response] with a [TokenPairResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenPairResponse>> refreshToken({
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> register({
  ...
  Future<Response<MessageResponse>> resetPassword({
    ...
    final _path = r'/api/auth/reset-password';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
